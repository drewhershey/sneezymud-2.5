...
struct oset_field_data oset_field[25] = {
  {.set = {"", "", "", ""}, .description = {"", "", "", ""}},
  {.set = {"duration", "", "", ""},
    .description = {"(duration of light.  -1 for permanent)", "", "", ""}},
  {.set = {"level", "spell1", "spell2", "spell3"},
    .description = {"(level of spells)", "(first spell)", "(second)",
      "(third)"}},
  {.set = {"level", "max-charges", "charges", "spell"},
    .description = {"(level of spell)", "(maximum charges)", "(charges left)",
      "(spell)"}},
  {.set = {"level", "max-charges", "charges", "spell"},
    .description = {"(level of spell)", "(maximum charges)", "(charges left)",
      "(spell)"}},
  {.set = {"damage", "wtype", "", ""},
    .description = {"(weapon damage, in the form: XdY)", "(weapon type)", "",
      ""}},
  {.set = {"", "", "", ""}, .description = {"", "", "", ""}},
  {.set = {"", "", "", ""}, .description = {"", "", "", ""}},
  {.set = {"", "", "", ""}, .description = {"", "", "", ""}},
  ...
  {.set = {"", "", "", ""}, .description = {"", "", "", ""}},
  {.set = {"", "", "", ""}, .description = {"", "", "", ""}},
  {.set = {"capacity", "flags", "key", ""},
    .description = {"(container's capacity)", "(container flags)",
      "(opening key)", ""}},
  {.set = {"", "", "", ""}, .description = {"", "", "", ""}},
  {.set = {"capacity", "amount", "liquid", "poisoned"},
    .description = {"(capacity)", "(amount left)", "(liqid)", "(poisoned?)"}},
  {.set = {"", "", "", ""}, .description = {"", "", "", ""}},
  {.set = {"amount", "poisoned", "", ""},
    .description = {"(number of hours restored)", "(poisoned?)", "", ""}},
  {.set = {"amount", "", "", ""},
