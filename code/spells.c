...
void cast_burning_hands(signed char level, struct char_data* ch, char* arg,
...
void cast_call_lightning(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
      if (OUTSIDE(ch) && (weather_info.sky >= SKY_RAINING)) {
...
void cast_chill_touch(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_WAND:
...
void cast_vampiric_touch(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_WAND:
...
void cast_life_leech(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_shocking_grasp(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_colour_spray(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_earthquake(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
...
void cast_energy_drain(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_fireball(signed char level, struct char_data* ch, char* arg, int type,
...
void cast_harm(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_lightning_bolt(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_acid_blast(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_cone_of_cold(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
...
void cast_ice_storm(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
...
void cast_meteor_swarm(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_disintegrate(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_flamestrike(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_magic_missile(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_cause_light(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_cause_serious(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_cause_critic(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_geyser(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
...
void cast_green_slime(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static int enforce_verbal(struct char_data* ch) {
  ...
  if (!can_do_verbal(ch)) {
    act("$n opens his mouth as if to say something.", 1, ch, 0, nullptr,
      TO_ROOM);
...
static int perform_gestural(struct char_data* ch) {
  ...
  act("$n traces a magical rune in the air with his hands.", 1, ch, 0, nullptr,
    TO_ROOM);
...
static int use_component(struct char_data* ch, struct obj_data* o) {
  ...
  act("$n throws $p into the air... it explodes in a blast of light!", 1, ch,
    o, nullptr, TO_ROOM);
  act("You throw $p into the air... it explodes in a blast of light!", 1, ch,
    o, nullptr, TO_CHAR);
  extract_obj(o);
...
static void spell_create_golem(signed char level, struct char_data* ch,
  ...
  act("$n arrives in a puff of blue smoke!", 1, golem, 0, ch, TO_ROOM);
  ...
  if ((control = task_check(ch, control, modifier)) == CRITICAL_FAILURE) {
    act("$n loses control of the magic he has unleashed!", 1, ch, 0, golem,
      TO_ROOM);
    act("You lose control of the magic you have unleased!", 1, ch, 0, golem,
      TO_CHAR);
    ...
    if (control == CRITICAL_SUCCESS) {
      act("$n beams with pride.  $N flexes.", 1, ch, 0, golem, TO_ROOM);
...
void cast_create_golem(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void spell_resurrection(signed char level, Mob* ch, Mob* victim, Obj* obj) {
  ...
  if (IS_CORPSE(obj)) {
    if (obj->char_vnum) { /* corpse is a npc */
      ...
      act("With mystic power, $n resurrects a corpse.", 1, ch, 0, 0,
        TO_ROOM);
      act("$N slowly rises from the ground.", 0, ch, 0, victim, TO_ROOM);
   ...
   */
      ...
      if (IsImmune(victim, IMM_CHARM) || IsResist(victim, IMM_CHARM)) {
        act("$N says 'Thank you'", 0, ch, 0, victim, TO_ROOM);
      } else {
        af.type = SPELL_CHARM_PERSON;
        af.duration = 36;
        af.modifier = 0;
...
void cast_resurrection(signed char level, struct char_data* ch, char* arg,
...
static void spell_track(signed char level, struct char_data* ch,
  ...
  act("$N's eyes take on an emerald hue for just a moment.", 0, ch, 0, targ,
    TO_ROOM);
...
void cast_major_track(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
      if (!tar_ch) {
...
void cast_minor_track(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
      if (!tar_ch) {
...
void cast_mana(signed char level, struct char_data* ch, char* arg, int type,
...
void cast_armor(signed char level, struct char_data* ch, char* arg, int type,
  ...
  switch (type) {
    case SPELL_TYPE_SPELL:
      ...
      if (ch != tar_ch) {
        act("$N is protected.", 0, ch, 0, tar_ch, TO_CHAR);
      }
...
static void spell_stone_skin(signed char level, struct char_data* ch,
  ...
  if (!affected_by_spell(ch, SPELL_STONE_SKIN)) {
    act("$n's skin turns grey and granite-like.", 1, ch, 0, 0, TO_ROOM);
    act("Your skin turns to a stone-like substance.", 1, ch, 0, 0, TO_CHAR);
...
void cast_stone_skin(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
      if (affected_by_spell(ch, SPELL_STONE_SKIN)) {
...
static void spell_vitalize_mana(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  send_to_char("Vitalize mana has been disabled.\n\r", ch);
}

void cast_vitalize_mana(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void spell_astral_walk(signed char level, struct char_data* ch,
  ...
  act("$n opens a door to another dimension and steps through!", 0, ch, 0,
    0, TO_ROOM);
  char_from_room(ch);
  char_to_room(ch, location);
  act("You are blinded for a moment as $n appears in a flash of light!", 0,
    ch, 0, 0, TO_ROOM);
  do_look(ch, "", 15);
}
...
void cast_farlook(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
    ...
    case SPELL_TYPE_WAND:
      ...
      if (!tar_ch) {
        ...
        spell_farlook(level, ch, tar_ch, 0);
      }
      break;
...
static void spell_portal(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  int location;
  char buf[30000];
  ...
  act("$p suddenly appears out of a swirling mist.", 1, ch, tmp_obj, 0,
    TO_ROOM);
  act("$p suddenly appears out of a swirling mist.", 1, ch, tmp_obj, 0,
    TO_CHAR);
}
...
void spell_teleport(signed char level, struct char_data* ch,
  ...
  act("$n slowly fade out of existence.", 0, ch, 0, 0, TO_ROOM);
  char_from_room(ch);
  char_to_room(ch, to_room);
  act("$n slowly fade in to existence.", 0, ch, 0, 0, TO_ROOM);
...
static void spell_bless(signed char level, struct char_data* ch,
  ...
  if (obj) {
    if ((5 * GET_LEVEL(ch, CLERIC_LEVEL_IND) > GET_OBJ_WEIGHT(obj)) &&
      ...
      act("$p briefly glows.", 0, ch, obj, 0, TO_CHAR);
    }
  } else {
...
void cast_infravision(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  struct affected_type af;
...
void cast_true_seeing(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void spell_blindness(signed char level, struct char_data* ch,
  ...
  act("$n seems to be blinded!", 1, victim, 0, 0, TO_ROOM);
...
void cast_blindness(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  struct affected_type af;
...
static void spell_light(signed char level, struct char_data* ch,
  ...
  */
  ...
  act("$n twiddles $s thumbs and $p suddenly appears.", 1, ch, tmp_obj, 0,
    TO_ROOM);
  act("You twiddle your thumbs and $p suddenly appears.", 1, ch, tmp_obj, 0,
    TO_CHAR);
}

void cast_light(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_cont_light(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_calm(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  assert(ch && victim);
...
void cast_control_weather(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
...
static void spell_create_food(signed char level, struct char_data* ch,
  ...
  act("$p suddenly appears.", 1, ch, tmp_obj, 0, TO_ROOM);
  act("$p suddenly appears.", 1, ch, tmp_obj, 0, TO_CHAR);
}

void cast_create_food(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
      act("$n magically creates a mushroom.", 0, ch, 0, 0, TO_ROOM);
  ...
  if (GET_ITEM_TYPE(obj) == ITEM_DRINKCON) {
    if ((obj->obj_flags.value[2] != LIQ_WATER) &&
      ...
      if (water > 0) {
        ...
        act("$p is partially filled.", 0, ch, obj, 0, TO_CHAR);
      }
    }
  }
}

void cast_create_water(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_water_breath(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;

  assert(ch && victim);

  act("You feel fishy!", 1, ch, 0, victim, TO_VICT);
  if (victim != ch) {
    act("$N makes a face like a fish.", 1, ch, 0, victim, TO_CHAR);
  }
  act("$N makes a face like a fish.", 1, ch, 0, victim, TO_NOTVICT);
...
void cast_water_breath(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_fly(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;

  assert(ch && victim);

  act("You feel lighter than air!", 1, ch, 0, victim, TO_VICT);
  if (victim != ch) {
    act("$N's feet rise off the ground.", 1, ch, 0, victim, TO_CHAR);
  } else {
    send_to_char("Your feet rise up off the ground.\n\r", ch);
  }
  act("$N's feet rise off the ground.", 1, ch, 0, victim, TO_NOTVICT);
...
void cast_flying(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_fly_group(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
  ...
  for (tch = real_roomp(ch->in_room)->people; tch; tch = tch->next_in_room) {
    if (in_group(ch, tch)) {
      act("You feel lighter than air!", 1, ch, 0, tch, TO_VICT);
      if (tch != ch) {
        act("$N's feet rise off the ground.", 1, ch, 0, tch, TO_CHAR);
      } else {
        send_to_char("Your feet rise up off the ground.", ch);
      }
      act("$N's feet rise off the ground.", 1, ch, 0, tch, TO_NOTVICT);
...
void cast_fly_group(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_WAND:
...
static void spell_heroes_feast(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct room_data* rp;
  struct char_data* tch;
...
void cast_heroes_feast(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_WAND:
...
static void spell_synostodweomer(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  int hitp;
  assert(victim);
...
void cast_synostodweomer(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_heal_spray(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct room_data* rp;
  struct char_data* tch;
...
void cast_heal_spray(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_WAND:
...
static void spell_cure_blind(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  assert(victim);
  assert((level >= 0) && (level <= ABS_MAX_LVL));
...
void cast_cure_blind(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_cure_critic(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  int healpoints;
...
void cast_cure_critic(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_cure_light(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  int healpoints;
...
void cast_cure_light(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_cure_serious(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_refresh(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_second_wind(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_shield(signed char level, struct char_data* ch,
  ...
  if (!affected_by_spell(victim, SPELL_SHIELD)) {
    act("$N is surrounded by a strong force shield.", 1, ch, 0, victim,
      TO_NOTVICT);
    if (ch != victim) {
      act("$N is surrounded by a strong force shield.", 1, ch, 0, victim,
        TO_CHAR);
      act("You are surrounded by a strong force shield.", 1, ch, 0, victim,
        TO_VICT);
    } else {
      act("You are surrounded by a strong force shield.", 1, ch, 0, victim,
        TO_VICT);
...
void cast_shield(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_curse(signed char level, struct char_data* ch,
  ...
  if (obj) {
    ...
    act("$p glows red.", 0, ch, obj, 0, TO_CHAR);
  } else {
    if (saves_spell(victim, SAVING_SPELL) ||
    ...
    act("$n briefly reveal a red aura!", 0, victim, 0, 0, TO_ROOM);
    act("You feel very uncomfortable.", 0, victim, 0, 0, TO_CHAR);
...
static void spell_dispel_invisible(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
  ...
  if (obj) {
    if (IS_SET(obj->obj_flags.extra_flags, ITEM_INVISIBLE)) {
      act("$p fades into visibility.", 0, ch, obj, 0, TO_CHAR);
      act("$p fades into visibility.", 1, ch, obj, 0, TO_ROOM);
      obj->obj_flags.extra_flags -= ITEM_INVISIBLE;
    }
  } else {
    if (affected_by_spell(victim, SPELL_INVISIBLE)) {
      act("$n slowly fades into existance.", 1, victim, 0, 0, TO_ROOM);
...
void cast_dispel_invisible(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  char buf[255];
...
static void spell_detect_evil(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
  ...
  act("$n's eyes briefly glow white", 0, victim, 0, 0, TO_ROOM);
  send_to_char("Your eyes tingle.\n\r", victim);
}

void cast_detect_evil(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_detect_invisibility(signed char level, struct char_data* ch,
  ...
  affect_to_char(victim, &af);
  act("$n's eyes briefly glow yellow", 0, victim, 0, 0, TO_ROOM);
  send_to_char("Your eyes tingle.\n\r", victim);
}
...
static void spell_detect_magic(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
...
void cast_detect_magic(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void spell_detect_poison(signed char level, struct char_data* ch,
  ...
  if (victim) {
    if (victim == ch) {
      ...
      act("You sense that $E is poisoned.", 0, ch, 0, victim, TO_CHAR);
    } else {
      act("You sense that $E is poisoned", 0, ch, 0, victim, TO_CHAR);
    }
  } else { /* It's an object */
    if ((obj->obj_flags.type_flag == ITEM_DRINKCON) ||
      ...
      if (obj->obj_flags.value[3]) {
        act("Poisonous fumes are revealed.", 0, ch, 0, 0, TO_CHAR);
      } else {
...
void cast_detect_poison(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_dispel_evil(signed char level, struct char_data* ch,
  ...
  if (IsExtraPlanar(victim)) {
    if (IS_EVIL(ch)) {
      ...
      if (IS_GOOD(victim)) {
        act("Good protects $N.", 0, ch, 0, victim, TO_CHAR);
        return;
      }
    }
    if (!saves_spell(victim, SAVING_SPELL)) {
      act("$n forces $N from this plane.", 1, ch, 0, victim, TO_ROOM);
      act("You force $N from this plane.", 1, ch, 0, victim, TO_CHAR);
      act("$n forces you from this plane.", 1, ch, 0, victim, TO_VICT);
      gain_exp(ch, MIN(GET_EXP(victim) / 2, 50000));
      extract_char(victim);
    }
  } else {
    act("$N laughs at you.", 1, ch, 0, victim, TO_CHAR);
    act("$N laughs at $n.", 1, ch, 0, victim, TO_NOTVICT);
    act("You laugh at $n.", 1, ch, 0, victim, TO_VICT);
  }
}

void cast_dispel_evil(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_dispel_good(signed char level, struct char_data* ch,
  ...
  if (IsExtraPlanar(victim)) {
    if (IS_GOOD(ch)) {
      ...
      act("Evil protects $N.", 0, ch, 0, victim, TO_CHAR);
      return;
    }

    if (!saves_spell(victim, SAVING_SPELL)) {
      act("$n forces $N from this plane.", 1, ch, 0, victim, TO_NOTVICT);
      act("You force $N from this plane.", 1, ch, 0, victim, TO_CHAR);
      act("$n forces you from this plane.", 1, ch, 0, victim, TO_VICT);
      gain_exp(ch, MIN(GET_EXP(victim) / 2, 50000));
      extract_char(victim);
...
void cast_dispel_good(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void spell_faerie_fire(signed char level, struct char_data* ch,
  ...
  act("$n points at $N.", 1, ch, 0, victim, TO_ROOM);
  act("You point at $N.", 1, ch, 0, victim, TO_CHAR);
  act("$N is surrounded by a pink outline", 1, ch, 0, victim, TO_ROOM);
  act("$N is surrounded by a pink outline", 1, ch, 0, victim, TO_CHAR);
...
void cast_faerie_fire(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_enchant_weapon(signed char level, struct char_data* ch,
  ...
  if ((GET_ITEM_TYPE(obj) == ITEM_WEAPON) &&
    ...
    if (IS_GOOD(ch)) {
      ...
      act("$p glows blue.", 0, ch, obj, 0, TO_CHAR);
    } else if (IS_EVIL(ch)) {
      SET_BIT(obj->obj_flags.extra_flags, ITEM_ANTI_GOOD);
      act("$p glows red.", 0, ch, obj, 0, TO_CHAR);
    } else {
      act("$p glows yellow.", 0, ch, obj, 0, TO_CHAR);
    }
  }
}

void cast_enchant_weapon(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_heal(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  assert(victim);
...
void cast_heal(signed char level, struct char_data* ch, char* arg, int type,
  ...
  switch (type) {
    case SPELL_TYPE_SPELL:
      ...
      act("You heal $N.", 0, ch, 0, tar_ch, TO_CHAR);
...
static void spell_full_heal(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  assert(victim);
...
void cast_full_heal(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
      act("$n heals $N.", 0, ch, 0, tar_ch, TO_NOTVICT);
    ...
    if ((ch->in_room == tmpv->in_room) && (ch != tmpv)) {
      if (in_group(ch, tmpv)) {
        if (!affected_by_spell(tmpv, SPELL_INVISIBLE)) {
          act("$n slowly fades out of existence.", 1, tmpv, 0, 0, TO_ROOM);
...
static void spell_invisibility(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
  ...
  if (obj) {
    if (!IS_SET(obj->obj_flags.extra_flags, ITEM_INVISIBLE)) {
      act("$p turns invisible.", 0, ch, obj, 0, TO_CHAR);
      act("$p turns invisible.", 1, ch, obj, 0, TO_ROOM);
      SET_BIT(obj->obj_flags.extra_flags, ITEM_INVISIBLE);
    }
  } else { /* Then it is a PC | NPC */
    if (!affected_by_spell(victim, SPELL_INVISIBLE)) {
      act("$n slowly fades out of existence.", 1, victim, 0, 0, TO_ROOM);
      send_to_char("You vanish.\n\r", victim);
...
void cast_invisibility(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
      if (tar_obj) {
...
void cast_locate_object(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
  ...
  if (victim) {
    ...
    if (IS_NPC(ch)) {
      if (!IS_SET(ch->specials.act, ACT_DEADLY)) {
        ...
        if (!imp_save_spell(victim, SAVING_PARA, 0)) {
          act("Deadly poison fills your veins.", 1, ch, 0, 0, TO_CHAR);
...
static void spell_protection_from_evil(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
  ...
  if (IS_EVIL(victim)) {
    act("$N's evilness disallows use of this spell.", 0, ch, 0, victim,
      TO_CHAR);
    return;
  }
...
static void spell_protection_from_good(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
  ...
  if (IS_GOOD(victim)) {
    act("$N is to holy for that spell.", 0, ch, 0, victim, TO_CHAR);
    return;
  }
...
static void spell_remove_curse(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
  ...
  if (obj) {
    if (IS_SET(obj->obj_flags.extra_flags, ITEM_NODROP)) {
      act("$p briefly glows blue.", 1, ch, obj, 0, TO_CHAR);
      REMOVE_BIT(obj->obj_flags.extra_flags, ITEM_NODROP);
    }
  } else { /* Then it is a PC | NPC */
    if (affected_by_spell(victim, SPELL_CURSE)) {
      act("$n briefly glows red, then blue.", 0, victim, 0, 0, TO_ROOM);
      act("You feel better.", 0, victim, 0, 0, TO_CHAR);
      affect_from_char(victim, SPELL_CURSE);
    }
  }
}

void cast_remove_curse(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_remove_poison(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  assert(ch && (victim || obj));
  ...
  if (victim) {
    if (affected_by_spell(victim, SPELL_POISON)) {
      ...
      act("A warm feeling runs through your body.", 0, victim, 0, 0,
        TO_CHAR);
      act("$N looks better.", 0, ch, 0, victim, TO_ROOM);
    }
  } else {
    if ((obj->obj_flags.type_flag == ITEM_DRINKCON) ||
        (obj->obj_flags.type_flag == ITEM_FOOD)) {
      obj->obj_flags.value[3] = 0;
      act("The $p steams briefly.", 0, ch, obj, 0, TO_CHAR);
    }
  }
}

void cast_remove_poison(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_remove_paralysis(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  assert(ch && victim);

  if (affected_by_spell(victim, SPELL_PARALYSIS)) {
    affect_from_char(victim, SPELL_PARALYSIS);
    act("A warm feeling runs through your body.", 0, victim, 0, 0, TO_CHAR);
    act("$N looks better.", 0, ch, 0, victim, TO_ROOM);
  }
}

void cast_remove_paralysis(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_sanctuary(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;

  if ((!affected_by_spell(victim, SPELL_SANCTUARY)) &&
      (!IS_AFFECTED(victim, AFF_SANCTUARY))) {
    act("$n is surrounded by a white aura.", 1, victim, 0, 0, TO_ROOM);
    act("You start glowing.", 1, victim, 0, 0, TO_CHAR);
...
void cast_sanctuary(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_silence(signed char level, struct char_data* ch,
  ...
  if ((!affected_by_spell(victim, SPELL_SILENCE)) &&
    ...
    act("$n has been muzzled!", 1, victim, 0, 0, TO_ROOM);
    act("You have been muzzled!", 1, victim, 0, 0, TO_CHAR);
...
void cast_silence(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_fireshield(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;

  if (!affected_by_spell(victim, SPELL_FIRESHIELD)) {
    act("$n is surrounded by a glowing red aura.", 1, victim, 0, 0, TO_ROOM);
    act("You start glowing red.", 1, victim, 0, 0, TO_CHAR);
...
void cast_fireshield(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_sleep(signed char level, struct char_data* ch,
  ...
  if (GET_POS(victim) > POSITION_SLEEPING) {
    act("You feel very sleepy ..... zzzzzz", 0, victim, 0, 0, TO_CHAR);
    act("$n go to sleep.", 1, victim, 0, 0, TO_ROOM);
...
static void spell_strength(signed char level, struct char_data* ch,
  ...
  if (!affected_by_spell(victim, SPELL_STRENGTH)) {
    act("You feel stronger.", 0, victim, 0, 0, TO_CHAR);
    ...
    act("Nothing seems to happen.", 0, ch, 0, 0, TO_CHAR);
  }
}
...
void cast_ventriloquate(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
...
static void spell_word_of_recall(signed char level, struct char_data* ch,
  ...
  act("$n disappears.", 1, victim, 0, 0, TO_ROOM);
  char_from_room(victim);
  char_to_room(victim, location);
  act("$n appears in the middle of the room.", 1, victim, 0, 0, TO_ROOM);
  do_look(victim, "", 15);
  GET_MOVE(victim) -= 100;
...
void cast_word_of_recall(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void raw_summon(struct char_data* v, struct char_data* c) {
  ...
  if (IS_NPC(v) && (!IS_SET(v->specials.act, ACT_POLYSELF)) &&
    ...
    act("$N struggles, and all of $S items are destroyed!", 1, c, 0, v,
      TO_CHAR);
  ...
  act("$n disappears suddenly.", 1, v, 0, 0, TO_ROOM);
  target = c->in_room;
  char_from_room(v);
  char_to_room(v, target);

  act("$n arrives suddenly.", 1, v, 0, 0, TO_ROOM);
  act("$n has summoned you!", 0, c, 0, v, TO_VICT);
  do_look(v, "", 15);
...
static void spell_charm_person(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
  ...
  if (!IS_AFFECTED(victim, AFF_CHARM) && !IS_AFFECTED(ch, AFF_CHARM)) {
    ...
    act("Isn't $n just such a nice fellow?", 0, ch, 0, victim, TO_VICT);
  }
}

void cast_charm_person(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_charm_monster(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
...
void cast_charm_monster(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_control_undead(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
...
void cast_control_undead(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_sense_life(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_dragon_breath(signed char level, struct char_data* ch, char* arg,
    ...
    if (!affected_by_spell(ch, scan->spell[i])) {
      ...
      if (GET_CON(ch) < 4) {
        send_to_char(
          ...
          "floor.\n\r",
          ch);
        act("$n gags and pukes glowing goop all over the floor.", 0, ch, 0,
          ch, TO_NOTVICT);
        break;
      }
      if (level > MIN(GET_CON(ch) - 1, GetMaxLevel(ch))) {
        send_to_char(
          ...
          ch);
        act("$n gags and flops around on the floor a bit.", 0, ch, 0, ch,
          TO_NOTVICT);
...
void cast_fire_breath(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_frost_breath(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_acid_breath(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_gas_breath(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
void cast_lightning_breath(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    ...
    case SPELL_TYPE_WAND: {
      ...
      if (generic_find(arg, FIND_OBJ_INV | FIND_OBJ_ROOM, ch, &victim, &obj)) {
        if (obj->obj_flags.type_flag != ITEM_CONTAINER) {
          ...
          sprintf(buf, "<Click>\n\r");
          act("$n magically opens $p", 0, ch, obj, 0, TO_ROOM);
        }
        send_to_char(buf, ch);
        return;
      }
      if ((door = find_door(ch, otype, dir)) >= 0) {
        if (!IS_SET(EXIT(ch, door)->exit_info, EX_ISDOOR)) {
          ...
          if (EXIT(ch, door)->keyword) {
            ...
            act("$n magically opens the lock.", 1, ch, 0, 0, TO_ROOM);
          }
...
void cast_know_alignment(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_weakness(signed char level, struct char_data* ch,
  ...
  if (!affected_by_spell(victim, SPELL_WEAKNESS)) {
    if (!saves_spell(victim, SAVING_SPELL)) {
      ...
      act("You feel weaker.", 0, victim, 0, 0, TO_VICT);
      act("$n seems weaker.", 0, victim, 0, 0, TO_ROOM);
...
void cast_weakness(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_WAND:
    case SPELL_TYPE_SPELL:
...
void spell_dispel_magic(signed char level, struct char_data* ch,
  ...
  if (affected_by_spell(victim, SPELL_SANCTUARY)) {
    if (yes || !saves_spell(victim, SAVING_SPELL)) {
      ...
      act("The white glow around $n's body fades.", 0, victim, 0, 0,
        TO_ROOM);
    }
    /*
     *  aggressive Act.
  ...
  if (affected_by_spell(victim, SPELL_FIRESHIELD)) {
    if (yes || !saves_spell(victim, SAVING_SPELL)) {
      ...
      act("The red glow around $n's body fades.", 1, ch, 0, 0, TO_ROOM);
    }
  }
  if (affected_by_spell(victim, SPELL_FAERIE_FIRE)) {
    if (yes || !saves_spell(victim, SAVING_SPELL)) {
      ...
      act("The pink glow around $n's body fades.", 1, ch, 0, 0, TO_ROOM);
    }
  }
...
void cast_dispel_magic(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_WAND:
    case SPELL_TYPE_SPELL:
...
void spell_animate_dead(signed char level, struct char_data* ch,
  ...
  */
  ...
  act("With mystic power, $n animates a corpse.", 1, ch, 0, 0, TO_ROOM);
  act("$N slowly rises from the ground.", 0, ch, 0, mob, TO_ROOM);
...
void cast_animate_dead(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* tar_ch, struct obj_data* tar_obj) {
  struct obj_data* i;
...
static void spell_succor(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct obj_data* o;
  ...
  act("$n waves $s hand, and creates $p", 1, ch, o, 0, TO_ROOM);
...
static void spell_well_of_knowledge(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct obj_data* o;
...
void cast_well_of_knowledge(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_WAND:
...
void spell_paralyze(signed char level, struct char_data* ch,
  ...
  if (!IS_AFFECTED(victim, AFF_PARALYSIS)) {
    ...
    act("Your limbs freeze in place", 0, victim, 0, 0, TO_CHAR);
    act("$n is paralyzed!", 1, victim, 0, 0, TO_ROOM);
    GET_POS(victim) = POSITION_STUNNED;
...
void cast_paralyze(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_turn(signed char level, struct char_data* ch,
  ...
  if (IsUndead(victim)) {
    ...
    if (diff <= 0) {
      act("You are powerless to affect $N", 1, ch, 0, victim, TO_CHAR);
      return;
    }
    for (i = 1; i <= diff; i++) {
      if (!saves_spell(victim, SAVING_SPELL)) {
        act("$n forces $N from this room.", 1, ch, 0, victim, TO_NOTVICT);
        act("You force $N from this room.", 1, ch, 0, victim, TO_CHAR);
        act("$n forces you from this room.", 1, ch, 0, victim, TO_VICT);
        do_flee(victim, "", 0);
        break;
      }
    }
    ...
    act("$n just tried to turn you, what a moron!", 1, ch, 0, victim,
      TO_VICT);
    act("$N thinks $n is really strange.", 1, ch, 0, victim, TO_NOTVICT);
    act("Um... $N isn't undead...", 1, ch, 0, victim, TO_CHAR);
  }
}

void cast_turn(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
...
static void spell_faerie_fog(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
  struct char_data* tmpv;
  ...
  act("$n snaps $s fingers, and a cloud of purple smoke billows forth", 1,
    ch, 0, 0, TO_ROOM);
  act("You snap your fingers, and a cloud of purple smoke billows forth", 1,
    ch, 0, 0, TO_CHAR);
      ...
      if (!in_group(ch, tmpv)) {
        if (IS_AFFECTED(tmpv, AFF_INVISIBLE)) {
          if (saves_spell(tmpv, SAVING_SPELL)) {
            ...
            act("$n is briefly revealed, but dissapears again.", 1, tmpv, 0,
              0, TO_ROOM);
            act("You are briefly revealed, but dissapear again.", 1, tmpv, 0,
              0, TO_CHAR);
            SET_BIT(tmpv->specials.affected_by, AFF_INVISIBLE);
          } else {
            REMOVE_BIT(tmpv->specials.affected_by, AFF_INVISIBLE);
            act("$n is revealed!", 1, tmpv, 0, 0, TO_ROOM);
            act("You are revealed!", 1, tmpv, 0, 0, TO_CHAR);
          }
        }
      }
    }
...
void cast_faerie_fog(signed char level, struct char_data* ch, char* arg,
  int type, struct char_data* victim, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_STAFF:
...
static void spell_poly_self(signed char level, struct char_data* ch,
  ...
  act("$n's flesh melts and flows into the shape of $N", 1, ch, 0, mob,
    TO_ROOM);

  act("Your flesh melts and flows into the shape of $N", 1, ch, 0, mob,
    TO_CHAR);
...
static void spell_minor_create(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  assert(ch && obj);

  act("$n claps $s hands together.", 1, ch, 0, 0, TO_ROOM);
  act("You clap your hands together.", 1, ch, 0, 0, TO_CHAR);
  act("In a flash of light, $p appears.", 1, ch, obj, 0, TO_ROOM);
  act("In a flash of light, $p appears.", 1, ch, obj, 0, TO_CHAR);
...
static void spell_conjure_elemental(signed char level, struct char_data* ch,
  struct char_data* victim, struct obj_data* obj) {
  struct affected_type af;
  ...
  */
  ...
  act("$n gestures, and a cloud of smoke appears", 1, ch, 0, 0, TO_ROOM);
  act("$n gestures, and a cloud of smoke appears", 1, ch, 0, 0, TO_CHAR);
  act("$p explodes with a loud BANG!", 1, ch, obj, 0, TO_ROOM);
  act("$p explodes with a loud BANG!", 1, ch, obj, 0, TO_CHAR);
  obj_from_char(obj);
  extract_obj(obj);
  char_to_room(victim, ch->in_room);
  act("Out of the smoke, $N emerges", 1, ch, 0, victim, TO_NOTVICT);
...
void spell_cacaodemon(signed char level, struct char_data* ch,
  ...
  act("$n gestures, and a black cloud of smoke appears", 1, ch, 0, 0,
    TO_ROOM);
  act("$n gestures, and a black cloud of smoke appears", 1, ch, 0, 0,
    TO_CHAR);
  act("$p bursts into flame and disintegrates!", 1, ch, obj, 0, TO_ROOM);
  act("$p bursts into flame and disintegrates!", 1, ch, obj, 0, TO_CHAR);
  obj_from_char(obj);
  extract_obj(obj);
  char_to_room(victim, ch->in_room);

  act("With an evil laugh, $N emerges from the smoke", 1, ch, 0, victim,
    TO_NOTVICT);
...
static void spell_create_monster(signed char level, struct char_data* ch,
  ...
  act("$n waves $s hand, and $N appears!", 1, ch, 0, mob, TO_ROOM);
  act("You wave your hand, and $N appears!", 1, ch, 0, mob, TO_CHAR);
...
void cast_mon_sum1(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
...
void cast_mon_sum2(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
...
void cast_mon_sum3(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
...
void cast_mon_sum4(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
...
void cast_mon_sum5(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
...
void cast_mon_sum6(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
...
void cast_mon_sum7(signed char level, struct char_data* ch, char* arg, int type,
  struct char_data* tar_ch, struct obj_data* tar_obj) {
  switch (type) {
    case SPELL_TYPE_SPELL:
    case SPELL_TYPE_SCROLL:
