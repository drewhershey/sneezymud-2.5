                ...
                if (((sub_object->obj_flags.weight) +
                  ...
                  if (bits == FIND_OBJ_INV) {
                    ...
                    switch (obj_object->obj_flags.material_points) {
                      ...
                      case 54:
                      case 55: {
                        act("You fold $p into $P.", 1, ch, obj_object,
                          sub_object, TO_CHAR);
                        act("$n folds $p into $P.", 1, ch, obj_object,
                          sub_object, TO_ROOM);
                      } break;
                      case 4:
                      case 61: {
                        act("You gently place $p in $P.", 1, ch, obj_object,
                          sub_object, TO_CHAR);
                        act("$n gently places $p in $P.", 1, ch, obj_object,
                          sub_object, TO_ROOM);
                      } break;
                      default: {
                        act("You pack $p into $P.", 1, ch, obj_object,
                          sub_object, TO_CHAR);
                        act("$n packs $s $p into $P,", 1, ch, obj_object,
                          sub_object, TO_ROOM);
                      } break;
                    }
                  }
