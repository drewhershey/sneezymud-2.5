...
# AddressSanitizer, UndefinedBehaviorSanitizer, and LeakSanitizer configuration
#
...
if(SNEEZY_ENABLE_UBSAN)
    ...
    # - implicit-integer-sign-change: various library char trait handling
    target_compile_options(sneezy_sanitizers INTERFACE
...
# LeakSanitizer (LSan)
# Catches: memory leaks at program exit
# Note: LSan is included with ASan, but can also run standalone
if(SNEEZY_ENABLE_LSAN)
    message(STATUS "LeakSanitizer enabled")

    # Only add standalone leak sanitizer if ASan is not enabled
    # (ASan already includes LeakSanitizer)
    if(NOT SNEEZY_ENABLE_ASAN)
        target_compile_options(sneezy_sanitizers INTERFACE
            -fsanitize=leak
        )
        target_link_options(sneezy_sanitizers INTERFACE
